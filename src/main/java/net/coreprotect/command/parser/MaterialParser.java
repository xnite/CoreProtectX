                            ...
                            if (!checkTags(i3, restricted)) {
                                ...
                                if (i3_material != null && (i3_material.isBlock() || argAction.contains(4))) {
                                    ...
                                    if (i3_entity != null) {
                                        ...
                                        Chat.sendMessage(player, Color.DARK_AQUA + "CoreProtectX " + Color.WHITE + "- " + Phrase.build(Phrase.INVALID_INCLUDE, i3));
                                        // Functions.sendMessage(player, Color.DARK_AQUA + "CoreProtectX " + Color.WHITE + "- " + Phrase.build(Phrase.MISSING_PARAMETERS, "/co help include"));
                                        return null;
                                    }
                                }
                            }
                        ...
                        if (!checkTags(argument, restricted)) {
                            ...
                            if (material != null && (material.isBlock() || argAction.contains(4))) {
                                ...
                                if (entityType != null) {
                                    ...
                                    Chat.sendMessage(player, Color.DARK_AQUA + "CoreProtectX " + Color.WHITE + "- " + Phrase.build(Phrase.INVALID_INCLUDE, argument));
                                    // Functions.sendMessage(player, Color.DARK_AQUA + "CoreProtectX " + Color.WHITE + "- " + Phrase.build(Phrase.MISSING_PARAMETERS, "/co help include"));
                                    return null;
                                }
                            }
